...
# Hyperparameters
context_length = 128  # Length of the token chunk each batch随机从测试集中随机抽取对应个数token参与训练计算weights
d_model = 512
...
class TransformerLanguageModel(nn.Module):
    def __init__(self, max_token_value=100080): # if not default to 100080, force to be default tiktoken cl100k vocal size
        super().__init__()
        self.d_model = d_model
        self.context_length = context_length
        self.num_heads = num_heads
